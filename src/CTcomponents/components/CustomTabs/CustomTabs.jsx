...
class CustomTabs extends React.Component {
	...
	render() {
		const { classes, headerColor, plainTabs, tabs, title, rtlActive, fullHeight } = this.props;
		const cardTitle = classNames({
			[classes.cardTitle]: true,
			[classes.cardTitleRTL]: rtlActive
		});
		return (
			<Card plain={plainTabs} style={{ marginTop: "2%",height:fullHeight? window.innerHeight:"auto"}}>
