...
class SecondHeaderTab extends Component {
    state = {};
    popperFilter = event => {
    ...
    render() {
        const { classes, headerTitle, buttons, tabButtons } = this.props;
        const {
            anchorEl,
            anchorElFilter,
            anchorElSort,
            ...
            <GridContainer>
                ...
                <GridItem xs={12} sm={12} md={6} lg={6}>
                    ...
                    <div className={classes.sectionMobile}>
                        <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-evenly", left: 10, marginTop: 10 }}>
                        {/*                             
...
SecondHeaderTab.defaultProps = {};

SecondHeaderTab.propTypes = {
    classes: PropTypes.object.isRequired,
    headerTitle: PropTypes.string.isRequired,
    buttons: PropTypes.node
};

export default withStyles(styles)(SecondHeaderTab);