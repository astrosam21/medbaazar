			...
			<div>
				...
				<div>
					...
					<Menu id="simple-menu" anchorEl={anchorEl} open={Boolean(anchorEl)} onClose={this.handleClose}>
						<MenuItem onClick={this.handleUnfollowAction}>Log a Call</MenuItem>
						<MenuItem onClick={this.handleViewAllAction}>Log a Mail</MenuItem>
						<MenuItem onClick={this.handleHistoryAction}>Log a Meeting</MenuItem>
					</Menu>
				</div>
				<br />
			</div>
